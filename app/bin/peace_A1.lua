...
function main_interpolator_peace_A1(i_cef_filepath_PEA_MOMENTS,              -- // PEA_MOMENTS
                                    i_cef_filepath_FGM_5VPS,                  -- // FGM_5VPS
                                    i_cef_filepath_AUX_PosGSE_1M,            -- // AUX_PosGSE_1M
                                    i_cef_filepath_AUX_LatLong,                 -- // AUX_LatLong
                                    i_out_folder)
                                     
    local m_file_data = get_file_data(i_cef_filepath_PEA_MOMENTS)
...
-- //    local m_cef_writer_L3_EV3D_GSE_EX   = m_cef_writer_factory:open("L3_EV3D_GSE_EX")
    ...
    local m_cef_writer_PEA_MOMENTS_ISR2_INERT   = m_cef_writer_factory:open("PEA_MOMENTS_ISR2_INERT")
    
    local m_data =
    {
      {
          filepath = i_cef_filepath_PEA_MOMENTS,
          tag = "PEA_MOMENTS",
          vars =
          {
              "time_tags__",                                                    -- // T0
...
--  //
    ...
    function process_peace_A1(Vx,Vy,Vz,
    ...
    -- // Dataset name: C1_CP_PEA_MOMENTS_ISR2_INERT
    ...
    -- // Metadata for variables of sections 7 require editing although the metadata of Data_Velocity_GSE gives a good start
        ...
        m_cef_writer_PEA_MOMENTS_ISR2_INERT:writeln(T0,                         -- // 8. Write new dataset 
                                                    V1x,V1y,V1z,                                
                                                    V2x,V2y,V2z,                                
                                                    V1px,V1py,V1pz,                                
                                                    V2px,V2py,V2pz,
...
main_interpolator_peace_A1(arg[1],                     -- // PEA_MOMENTS
                           arg[2],                     -- // FGM_5VPS
